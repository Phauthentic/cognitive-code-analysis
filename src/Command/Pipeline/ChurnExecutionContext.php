...
/**
 * Execution context that flows through churn pipeline stages.
 * Stores command state, timing information, and intermediate results.
 */
class ChurnExecutionContext
{
    ...
    public function __construct(
        private readonly ChurnCommandContext $commandContext,
     ...
     */
    public function getCommandContext(): ChurnCommandContext
    {
