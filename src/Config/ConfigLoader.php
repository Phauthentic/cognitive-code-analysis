                ...
                ->arrayNode('cognitive')
                    ->children()
                        ->arrayNode('excludePatterns')
                            ...
                            ->end()
                        ->end()
                        ->arrayNode('excludeFilePatterns')
                            ->scalarPrototype()
                            ->defaultValue([])
                            ->end()
                        ->end()
                        ->floatNode('scoreThreshold')
                            ->defaultValue(0.5)
                        ->end()
                        ...
                        ->booleanNode('showCyclomaticComplexity')
                            ->defaultValue(false)
                        ->end()
                        ->booleanNode('showUnderstandability')
                            ->defaultValue(false)
                        ->end()
                        ->booleanNode('groupByClass')
                            ->defaultValue(true)
                        ->end()
                        ->booleanNode('showDetailedCognitiveMetrics')
                            ->defaultValue(true)
                        ->end()
                        ->arrayNode('metrics')
